...
void actionreload (Game game, int n,int m,char c) {
    ...
    if (n == 0) {
       ...
       game->actions[0].color = 0;
        ...
        if (c == 'w') strcpy (game->actions[0].line,"A weapon drops");
        else strcpy (game->actions[0].line,"An armor drops");
        game->actions[0].color = 1;
    }
    else if (n == 7) {
        if (c == 'w') strcpy (game->actions[0].line,"You see a weapon");
        else strcpy (game->actions[0].line,"You see armor");
        game->actions[0].color = 1;
    }
}
